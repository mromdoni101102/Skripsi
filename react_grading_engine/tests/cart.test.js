...
describe('Praktikum: Komponen Cart (Studi Kasus)', () => {
    ...
    beforeEach(() => {
     ...
     test('Kriteria 1 [W=10]: Harus menampilkan pesan "Belum ada pesanan" saat keranjang kosong', () => {
    ...
    test('Kriteria 2 [W=15]: Harus menampilkan semua item dan total belanja dengan benar', () => {
    ...
    // Bobot tertinggi karena menguji interaksi paling kompleks (event -> confirm -> callback).
    test('Kriteria 3 [W=25]: Tombol "Hapus" harus memanggil fungsi onRemove jika dikonfirmasi', () => {
    ...
    // Bobot tinggi karena menguji cabang lain dari logika 'confirm'.
    test('Kriteria 4 [W=20]: Tombol "Hapus" TIDAK memanggil onRemove jika tidak dikonfirmasi', () => {
    ...
    test('Kriteria 5 [W=10]: Harus menampilkan "Gratis ongkir!" jika total > 100000', () => {
    ...
    test('Kriteria 6 [W=10]: Harus menampilkan "Tidak Dapat Gratis Ongkir" jika total <= 100000', () => {
    ...
    test('Kriteria 7 [W=10]: Tombol "Checkout" harus memanggil fungsi onCheckout saat diklik', () => {
        render(<Cart total={45000} items={mockItems} onRemove={mockOnRemove} onCheckout={mockOnCheckout} />);
