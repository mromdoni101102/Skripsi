    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-lg-6 content-left">
                ...
                <p class="where-education" style="line-height:60px ;">Where Your <span
                        class="education">Education</span> Has No
                    Limit</p>
                <p class="subtext">iCLOP (intelligent computer assisted programming learning platform)</p>
                <p class="subtext">With our easy-to-follow tutorials and examples, you can learn to code in no time.
                    Learn to
    ...
    <div class="container" style="margin-top: 10px">
        <div class="row">
            ...
            <div class="col-lg-6 content-right">
                ...
                <p style="font-size: 20px; margin-top: 35px;">Make learning an easy process with support for an online
                    virtual
                    machine which will relieve you from the hustle of finding the right computer for your learning
                    needs.</p>
            </div>
        </div>
        ...
        <div class="container"
            ...
            <p class="where-education" style="font-size: 35px; text-align: center; margin-top: 50px;">Choose What You
                Want To
                Study</p>
            ...
            <button class="btn btn-primary custom-button-sign-up"
                style="width: 252px; height: 42px; margin-top: 60px;">Load
                More</button>
        </div>
        ...
        <div class="container text-center" style="margin-top: 100px;">
            <div class="row">
                @foreach ($cardsData as $card)
                    <div class="col"
                        style="width: 430px; height: 440px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                        <div class="container">
                            <img src="{{ $card['image'] }}" alt="computer"
                                style="height: 102px; margin-left: 30px; margin-top: 20px;">
                            <p style="font-size: 22px; font-weight: 600; color: #34364A; margin-top: 24px;">
                                {{ $card['title'] }}</p>
