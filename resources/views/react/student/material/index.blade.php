                    ...
                    <div>
                        <div class="container mt-4">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                @if ($role == 'teacher')
                                    <li class="nav-item">
                                        <a class="nav-link" id="finished-tab" data-toggle="tab"
                            ...
                            <div class="tab-content mt-3">
                                <div class="tab-pane fade show active" id="learning">
                                    @foreach ($topics as $topic)
                                        @php
                                            $limit_id = $topic->id;
                                            $row = DB::table('react_topics_detail')
                                                ->where('react_topic_id', $limit_id)
                                                ->first();
                                            $rowArray = (array) $row;
                                            if ($row) {
                                                $rows = $row->id;
                                            ...
                                            <div class="col" style="text-align: right;">
                                                <div class="custom-button-detail">
                                                    ...
                                                    <a class="button-text" data-toggle="modal"
                                                        ...
                                                        onclick="materialModal('{{ $topic->id }}','{{ $topic->description }}','{{ $topic->react_topic_id }}')">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="text-sm" style="margin-bottom: 20px">
                                <p style="margin-bottom: 5px !important">Before starting React.js learning, you should
                                    have basic knowledge about <b>HTML, CSS, dan JavaScript</b>.</p>
                                1. HTML is used to design statistical web pages.<br>
                            ...
                            <div class="text-sm mb-10" style="margin-bottom: 20px">
                                ...
                                3. 120 GB HDD hard disk with minimum 20 GB available storage<br>
                                ...
                                <div class="col-md-6 text-center text-sm">
                                    <a href="https://react.dev/" target="_blank">
                                        <img style="width: 90px; height: 80px; object-fit: cover"
                                            src="{{ asset('./images/react/react.png') }}" alt="">
                                    </a>
                                    <br>
                                    React
                                </div>
        ...
        $(document).ready(function() {
            ...
            $('#progressTable').DataTable({
                ...
                buttons: [{
                        ...
                        filename: 'react_data_export_topic_finished_student_' + new Date()
                            .toLocaleDateString() + '_' + new Date().toLocaleTimeString(),
            ...
            $('#studentSubmissionTable').DataTable({
                ...
                buttons: [{
                        ...
                        text: 'Export to Excel',
                        title: 'Data Export REACT',
                        filename: 'react_data_export_student_submission_student_' + new Date()
                            .toLocaleDateString() + '_' + new Date().toLocaleTimeString(),
                        customize: function(xlsx) {
                            var sheet = xlsx.xl.worksheets['sheet1.xml'];
                            // Customizations go here
                    ...
                    },
                    {
                        ...
                        title: 'Data Export REACT',
                        filename: 'react_data_export_student_submission_student_' + new Date()
                            .toLocaleDateString().replace(/\//g, '-') + '_' + new Date()
            ...
            $('#finnishedProgressTable').DataTable({
                ...
                buttons: [{
                        ...
                        text: 'Export to Excel',
                        title: 'Data Export REACT',
                        filename: 'react_data_export_progress_student_' + new Date()
                            .toLocaleDateString() + '_' + new Date().toLocaleTimeString(),
                        customize: function(xlsx) {
                            var sheet = xlsx.xl.worksheets['sheet1.xml'];
                            // Customizations go here
